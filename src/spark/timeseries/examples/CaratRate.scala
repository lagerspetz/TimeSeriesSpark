...
class CaratRate(var uuid:String, val os:String, val model:String,
    ...
    val events1:Array[String], val events2:Array[String],
    val apps1:Array[String], val apps2:Array[String]) extends Ordered[CaratRate]{
  ...
  def this(uuid: String, os:String, model:String, time1: Long, time2:Long, battery1:Double, battery2:Double, events1:Array[String], events2: Array[String], apps1:Array[String], apps2:Array[String]){
